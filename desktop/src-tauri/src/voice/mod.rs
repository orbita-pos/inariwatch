...
pub use capabilities::{detect as detect_capabilities, VoiceCapabilities};
pub use models::{VoiceModel, VoiceQuality, VOICE_REGISTRY};
pub use settings::{VoiceSettings, VoiceSettingsPatch};
pub use stt::{
    empty_wav_16khz_mono, TranscribeError, TranscribeOpts, TranscriptionResult, WhisperBackend,
    WhisperCliBackend,
};
