...
// 6 routes mounted by Inari Live's main window
// (`screens/main/{Inbox,Activity,Audit,Memory,Patterns}.tsx` + Settings).
// Settings sits inline with the others (not pinned to a footer) so it
// doesn't get clipped on shorter window heights. v0.3 S11 added the
// "Audit" route between Activity and Memory — the agent's tool
// invocations live here.
const TOP_NAV: NavItem[] = [
  { id: "inbox",    label: "Inbox",    icon: Inbox,          shortcut: 1 },
  { id: "activity", label: "Activity", icon: Activity,       shortcut: 2 },
  { id: "audit",    label: "Audit",    icon: ClipboardList,  shortcut: 3 },
  { id: "memory",   label: "Memory",   icon: BookOpen,       shortcut: 4 },
  { id: "patterns", label: "Patterns", icon: Layers,         shortcut: 5 },
 ...
 *   - Cmd/Ctrl + 1..6 jump straight to the corresponding route
 *     (Inbox, Activity, Audit, Memory, Patterns, Settings).
 */
