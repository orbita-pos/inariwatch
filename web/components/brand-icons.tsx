...
export function GitHubIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={`fill-zinc-900 dark:fill-white ${className ?? ""}`} aria-label="GitHub" {...props}>
...
export function VercelIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={`fill-zinc-900 dark:fill-white ${className ?? ""}`} aria-label="Vercel" {...props}>
...
export function SentryIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#7C6BAB" className={className} aria-label="Sentry" {...props}>
...
export function PostgreSQLIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#4169E1" className={className} aria-label="PostgreSQL" {...props}>
...
export function NpmIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#CB3837" className={className} aria-label="npm" {...props}>
      <path d="M1.763 0C.786 0 0 .786 0 1.763v20.474C0 23.214.786 24 1.763 24h20.474c.977 0 1.763-.786 1.763-1.763V1.763C24 .786 23.214 0 22.237 0zM5.13 5.323l13.837.019-.009 13.836h-3.464l.01-10.382h-3.456L12.04 19.17H5.113z" />
    </svg>
  );
}

export function UptimeIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="#06B6D4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-label="Uptime Monitor" {...props}>
...
export function GitIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#F05032" className={className} aria-label="Git" {...props}>
...
export function CaptureIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-label="Capture" {...props}>
