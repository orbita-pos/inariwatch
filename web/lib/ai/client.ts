...
export interface CallAIOpts {
  ...
  task?: TaskName;
  /**
   * Qwen3-32B thinking mode budget (Together AI only).
   * Enables chain-of-thought reasoning before the final answer.
   * Silently ignored for all non-Together providers.
   */
