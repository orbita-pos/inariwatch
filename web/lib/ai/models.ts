...
// Together AI hosts open-weight Qwen models at far cheaper output pricing
// than OpenAI flagship. IDs verified against the Together serverless
// catalog 2026-05-13 (Mixtral-8x7B + Qwen2.5-Coder-32B were dropped from
// the catalog and replaced with the entries below). Platform-funded
// routing in `together-routing.ts` overrides these on a per-task basis;
// BYOK Together users see this list in Settings.
export const TOGETHER_MODELS: ModelInfo[] = [
  { id: "Qwen/Qwen3.5-9B-FP8",                          label: "Qwen3.5 9B",       desc: "Cheap classifier, $0.10/$0.15",       tier: "fast" },
  { id: "Qwen/Qwen3-Coder-Next-FP8",                    label: "Qwen3 Coder Next", desc: "Code-aware, $0.50/$1.20",             tier: "balanced" },
  { id: "Qwen/Qwen3-235B-A22B-Instruct-2507-tput", label: "Qwen3 235B A22B",  desc: "MoE flagship, thinking, $0.20/$0.60", tier: "balanced" },
  { id: "Qwen/Qwen3.6-Plus",                            label: "Qwen3.6 Plus",     desc: "78.8% SWE-bench, $0.50/$3.00",        tier: "powerful" },
  { id: "Qwen/Qwen3-Coder-480B-A35B-Instruct-FP8",      label: "Qwen3 Coder 480B", desc: "Largest code model, $2.00/M",         tier: "powerful" },
];
...
const DEFAULTS: Record<AIProvider, Record<AITask, string>> = {
  ...
  together: {
    // BYOK path — if a user brings their own Together key, use the best available
    // model per task. Platform-funded path overrides via getTogetherOverride().
    // IDs verified against Together's serverless catalog 2026-05-13.
    analysis:    "Qwen/Qwen3-235B-A22B-Instruct-2507-tput",
    triage:      "Qwen/Qwen3.5-9B-FP8",
    chat:        "Qwen/Qwen3-235B-A22B-Instruct-2507-tput",
    remediation: "Qwen/Qwen3.6-Plus",
    postmortem:  "Qwen/Qwen3-Coder-Next-FP8",
  },
};
