        ...
        <div className="px-5 py-4 space-y-3">
          ...
          {isCanceling && billing.periodEnd && (
            <div className="flex items-start gap-2 rounded-lg border border-amber-500/30 bg-amber-500/5 px-3 py-2">
              ...
              <div className="text-sm">
                <p className="text-amber-400 font-medium">Cancellation scheduled</p>
                <p className="text-xs text-zinc-500 mt-0.5">
  ...
  return (
    <div className="rounded-xl border border-line bg-surface-dim overflow-hidden">
      ...
      <div className="px-5 py-4">
        <div className="rounded-lg border border-inari-accent/30 bg-inari-accent/5 p-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              ...
              <div className="text-zinc-500 mt-0.5">Monthly</div>
            </button>
            <button
        ...
        <Link
          href="/pricing"
          className="flex items-center justify-center gap-1 text-xs text-zinc-500 hover:text-fg-base transition-colors"
        >
          See full pricing details <ArrowRight className="h-3 w-3" />
        </Link>
