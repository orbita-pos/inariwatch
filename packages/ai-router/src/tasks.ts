...
export const TASKS = {
  ...
  // translator. Single AI surface in the desktop chat input. Routed to
  // the ASSIST bucket (Qwen3.5-9B) on platform-funded users; ~$0.0001
  // per suggestion. See INARI_LIVE_PURE_SLASH_PLAN.md.
  CHAT_SUGGEST_COMMAND: "chat.suggest-command",
