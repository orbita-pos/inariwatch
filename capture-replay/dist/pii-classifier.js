 ...
 */
export function classifyField(features) {
 ...
 */
export function shouldMask(c) {
    if (c.category === "not_pii" || c.category === "uncertain")
        return false;
...
//# sourceMappingURL=pii-classifier.js.map