 ...
 */
import { buildPayloadV2Unsigned, computeEvidenceMerkleRootSync, estimateTokensTiktoken, } from "./payload-v2.js";
/**
 ...
 */
export async function prepareV2Payload(event) {
...
function intentCompilerEnabled() {
    const env = typeof process !== "undefined" && process.env
        ? process.env
        : {};
    const v = env.CAPTURE_INTENT_COMPILER ?? env.INARIWATCH_INTENT_COMPILER ?? "";
    return v === "1" || v === "true";
}
//# sourceMappingURL=v2-emit.js.map