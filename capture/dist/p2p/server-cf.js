 ...
 */
import { isFreshTimestamp, isPeerIdConsistent, verifySignatureV1, } from "./relay.js";
...
export class GossipRoom {
    ...
    handlePublish(session, ws, msg) {
        const nowMs = Date.now();
        if (msg.workspace_id !== session.workspaceId)
            return;
...
//# sourceMappingURL=server-cf.js.map