 ...
 */
export const noopVoid = (..._args) => { };
export const noopAsyncVoid = async (..._args) => { };
export const noopReturnArg = (arg) => arg;
export const noopRunFn = (_arg, fn) => fn();
export const noopReturnNull = (..._args) => null;
export const noopReturnEmpty = (..._args) => [];
export const noopReturnFalse = (..._args) => false;
export const noopReturnEmptyObj = (..._args) => ({});
