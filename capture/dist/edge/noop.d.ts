 ...
 */
export declare const noopVoid: (..._args: unknown[]) => void;
export declare const noopAsyncVoid: (..._args: unknown[]) => Promise<void>;
export declare const noopReturnArg: <T>(arg: T) => T;
export declare const noopRunFn: <T>(_arg: unknown, fn: () => T) => T;
export declare const noopReturnNull: (..._args: unknown[]) => null;
export declare const noopReturnEmpty: (..._args: unknown[]) => [];
export declare const noopReturnFalse: (..._args: unknown[]) => false;
export declare const noopReturnEmptyObj: (..._args: unknown[]) => Record<string, never>;
