...
const INSTALLED_MARKER = "__inariwatchAwakeSpaRoutingInstalled";
export function installSpaRouting(config) {
    ...
    function scheduleRouteEnd() {
        ...
        settlingTimer = setTimeout(() => {
            ...
            captureLog(`slow_route: ${durationMs}ms ${routeFrom ?? "?"} → ${to}`, levelForRating(rating), {
                kind: "spa_route",
                from: routeFrom,
                to,
                durationMs,
...
//# sourceMappingURL=spa-routing.js.map