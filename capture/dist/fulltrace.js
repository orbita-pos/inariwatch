...
function readGlobal() {
    if (typeof window === "undefined")
        return null;
    return window.__INARIWATCH_SESSION__ ?? null;
}
function writeGlobal(id) {
    if (typeof window === "undefined")
        return;
    window.__INARIWATCH_SESSION__ = id;
}
// ── public API ──────────────────────────────────────────────────────────────
/**
 ...
 */
export function initFullTrace(config = {}) {
    if (typeof window === "undefined")
        return;
    if (initialized)
        return;
 ...
 */
export function injectSessionHeader(url, init) {
    if (!shouldInject(url))
        return init;
...
export function __resetFullTraceForTesting() {
    activeSessionId = null;
    activeConfig = {};
    initialized = false;
    originHostname = "";
}
//# sourceMappingURL=fulltrace.js.map