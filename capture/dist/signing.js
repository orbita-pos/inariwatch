 ...
 */
export function getOrCreateKeypair(opts = {}) {
    if (cachedKeypair)
...
function loadKeypair(path) {
    try {
        ...
        if (typeof parsed.private_key_pem !== "string" ||
...
function generateKeypair() {
    ...
    if (!jwk.x)
        throw new Error("Ed25519 keypair generated without JWK x field");
...
function freshToPersisted(active) {
 ...
 */
export function signReceiptId(receiptIdHex, kp) {
 ...
 */
export function verifyReceiptIdSignature(receiptIdHex, signatureHex, publicKeyHex) {
...
export function __resetSigningCacheForTesting() {
    cachedKeypair = null;
}
/**
 ...
 */
export function __createInMemoryKeypair() {
