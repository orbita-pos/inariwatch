...
import { parseDSN, parseToken, createTransport, createLocalTransport } from "./transport.js";
...
import { resolveRedactConfig } from "./redact/config.js";
...
let cachedRedactPayload = null;
async function getRedactPayload() {
    if (cachedRedactPayload)
    ...
    const mod = await import(/* webpackIgnore: true */ redactMod);
