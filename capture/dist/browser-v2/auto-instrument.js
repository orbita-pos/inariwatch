...
export function installFetchWrap() {
    ...
    window.fetch = async function (input, init) {
        ...
        if (!headers.has("x-iw-session-id"))
...
export function installXhrWrap() {
    if (xhrInstalled || typeof XMLHttpRequest === "undefined")
        return;
    xhrInstalled = true;
    const Open = XMLHttpRequest.prototype.open;
    const Send = XMLHttpRequest.prototype.send;
    XMLHttpRequest.prototype.open = function (method, url, async, user, password) {
        this.__iwMethod = method;
        this.__iwUrl =
...
export function uninstallForTesting() {
    fetchInstalled = false;
    xhrInstalled = false;
}
//# sourceMappingURL=auto-instrument.js.map