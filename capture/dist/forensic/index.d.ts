...
export type { ForensicValue, FrameSnapshot, ForensicCapture, ForensicHook, ForensicOptions, } from "./types.js";
...
export { installSessionFile, updateRequestContext, uninstallSessionFile, } from "./session-file.js";
export type { SessionContext } from "./session-file.js";
export { forensicIntegration, __pushCaptureForTesting, __resetForensicIntegrationForTesting, } from "./integration.js";
 ...
 * the capture ingest.
 */
export declare function registerForensicHook(hook: ForensicHook, options?: ForensicOptions): Promise<{
    mode: "fork" | "inspector";
}>;
export declare function unregisterForensicHook(): Promise<void>;
/** Exposed for tests and debugging. */
export declare function __mode(): "fork" | "inspector" | null;
